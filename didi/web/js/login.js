function login_popup() {
    $("#user_name").val(""), $("#user_pwd").val(""), $("#login-form-tips").hide(),$("#loginModal").modal("show")
}
...
function hide_login_form() {
    $("#fa-car").addClass("hide");
    $("#user_photo").removeClass("hide");
...
function show_login_form() {
    ...
    $("#fa-car").removeClass("hide");
    $("#user_photo").addClass("hide");
}
 function check_login_input() {
    if(($("#user_name").val().length <= 0)){
        $("#user_name").focus();
        $("#login-form-tips").html("请重新输入用户名").show(500);
        return false;
    }else if(($("#user_pwd").val().length <= 0)) {
        $("#user_pwd").focus();
        $("#login-form-tips").html("请重新输入密码").show(500);
        return false;
    }else {
